...
Put one outfit per file in either place:

- `~/.agents/outfits/*.yaml`
- `<project>/.agents/outfits/*.yaml`

Project outfits override global outfits with the same filename stem. `deep-work.yaml` becomes outfit id `deep-work`.
